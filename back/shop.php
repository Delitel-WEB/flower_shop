				...
				<?php foreach ($products as $product): ?>
					<div class="flower-cart col-md-4 col-sm-4">
						<div class="flower-preview">
							<img src="<?php echo $product[4]; ?>" alt="">
						</div>
						<div class="flower-cart-content">
							<h2 class="text-center"><?php echo $product[1] ?></h2>
							<hr>
							<p><?php echo mb_substr($product[5], 0, 139) . "..."; ?></p>
							<div class="price">
								<h5><?php echo $product[2] ?>руб.</h5>
							</div>
							<div class="shop-item">
								<a href="/flower?flower_id=<?php echo $product[0]; ?>" title="Перейти к товару">
