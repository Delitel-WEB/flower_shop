			...
			<div class="catalog">
				<div class="row justify-content-center">
					<?php foreach($similarProducts as $prod): ?>
						<?php if ($prod['id'] != $productId): ?>
							<div class="flower-cart col-md-4 col-sm-4">
								<div class="flower-preview">
									<img src="<?php echo $prod['preview_image']; ?>" alt="">
								</div>
								<div class="flower-cart-content">
									<h2 class="text-center"><?php echo $prod['name']; ?></h2>
									<hr>
									<p><?php echo mb_substr($prod['description'], 0, 139) . "..."; ?></p>
									<div class="price">
										<h5><?php echo $prod['amount'] ?>руб.</h5>
									</div>
									<div class="shop-item">
										<a href="/flower?flower_id=<?php echo $prod['id']; ?>" title="Перейти к товару">
